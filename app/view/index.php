		...
		<div id="main-slide" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="item active" style="background-image:url(<?php echo URL?>assets/images/slider-main/bg1.jpg)">
				...
				<div class="item" style="background-image:url(<?php echo URL?>assets/images/slider-main/bg2.jpg)">
					<div class="slider-content text-left">
						<div class="col-md-12">
							<h2 class="slide-title-box animated2">Lorem Ipsum</h2>
							<h3 class="slide-title animated3">Blablabla Treino</h3>
							<h3 class="slide-sub-title animated3">Blablabla Treino</h3>
							<p class="animated3">
								<a href="services.html" class="slider btn btn-primary border">Nossos planos</a>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="item" style="background-image:url(<?php echo URL?>assets/images/slider-main/bg3.jpg)">
					...
					<div class="facts-wrapper">
						<div class="col-sm-3 ts-facts">
							<div class="ts-facts-img">
								<img src="<?php echo URL?>assets/images/icon-image/fact1.png" alt="" />
							</div>
						...
						<div class="col-sm-3 ts-facts">
							<div class="ts-facts-img">
								<img src="<?php echo URL?>assets/images/icon-image/fact2.png" alt="" />
							</div>
							<div class="ts-facts-content">
						...
						<div class="col-sm-3 ts-facts">
							<div class="ts-facts-img">
								<img src="<?php echo URL?>assets/images/icon-image/fact3.png" alt="" />
							</div>
							<div class="ts-facts-content">
						...
						<div class="col-sm-3 ts-facts">
							<div class="ts-facts-img">
								<img src="<?php echo URL?>assets/images/icon-image/fact4.png" alt="" />
							</div>
							<div class="ts-facts-content">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?php echo URL?>assets/images/icon-image/service-icon1.png" alt="" />
							</div>
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?php echo URL?>assets/images/icon-image/service-icon2.png" alt="" />
							</div>
							<div class="ts-service-box-info">
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?php echo URL?>assets/images/icon-image/service-icon3.png" alt="" />
							</div>
							<div class="ts-service-box-info">
					...
					<div class="col-md-4 text-center">
						<img class="service-center-img img-responsive" src="<?php echo URL?>assets/images/services/service-center.jpg" alt="" />
					</div><!-- Col end -->

					<div class="col-md-4">
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?php echo URL?>assets/images/icon-image/service-icon4.png" alt="" />
							</div>
							<div class="ts-service-box-info">
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?php echo URL?>assets/images/icon-image/service-icon5.png" alt="" />
							</div>
							<div class="ts-service-box-info">
						...
						<div class="ts-service-box">
							<div class="ts-service-box-img pull-left">
								<img src="<?php echo URL?>assets/images/icon-image/service-icon6.png" alt="" />
							</div>
							<div class="ts-service-box-info">
					...
					<div id="isotope" class="isotope">
						<div class="col-md-4 col-sm-6 col-xs-12 commercial isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?php echo URL?>assets/images/projects/project1.jpg">
									<img class="img-responsive" src="<?php echo URL?>assets/images/projects/project1.jpg" alt="">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 healthcare isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?php echo URL?>assets/images/projects/project2.jpg">
									<img class="img-responsive" src="<?php echo URL?>assets/images/projects/project2.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 government isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?php echo URL?>assets/images/projects/project3.jpg">
									<img class="img-responsive" src="<?php echo URL?>assets/images/projects/project3.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 education isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?php echo URL?>assets/images/projects/project4.jpg">
									<img class="img-responsive" src="<?php echo URL?>assets/images/projects/project4.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 infrastructure isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?php echo URL?>assets/images/projects/project5.jpg">
									<img class="img-responsive" src="<?php echo URL?>assets/images/projects/project5.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div class="col-md-4 col-sm-6 col-xs-12 residential isotope-item">
							<div class="isotope-img-container">
								<a class="gallery-popup" href="<?php echo URL?>assets/images/projects/project6.jpg">
									<img class="img-responsive" src="<?php echo URL?>assets/images/projects/project6.jpg" alt="">
									<span class="gallery-icon"><i class="fa fa-plus"></i></span>
								</a>
								<div class="project-item-info">
									<div class="project-item-info-content">
						...
						<div id="testimonial-slide" class="owl-carousel owl-theme testimonial-slide">
							<div class="item">
								<div class="quote-item">
									...
									<div class="quote-item-footer">
										<img class="testimonial-thumb" src="<?php echo URL?>assets/images/clients/testimonial1.png" alt="testimonial">
							...
							<div class="item">
								<div class="quote-item">
									...
									<div class="quote-item-footer">
										<img class="testimonial-thumb" src="<?php echo URL?>assets/images/clients/testimonial2.png" alt="testimonial">
										<div class="quote-item-info">
							...
							<div class="item">
								<div class="quote-item">
									...
									<div class="quote-item-footer">
										<img class="testimonial-thumb" src="<?php echo URL?>assets/images/clients/testimonial3.png" alt="testimonial">
										<div class="quote-item-info">
						...
						<div class="row all-clients">
							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?php echo URL?>assets/images/clients/client1.png" alt="" /></a>
								</figure>
							</div><!-- Client 1 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?php echo URL?>assets/images/clients/client2.png" alt="" /></a>
								</figure>
							</div><!-- Client 2 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?php echo URL?>assets/images/clients/client3.png" alt="" /></a>
								</figure>
							</div><!-- Client 3 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?php echo URL?>assets/images/clients/client4.png" alt="" /></a>
								</figure>
							</div><!-- Client 4 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?php echo URL?>assets/images/clients/client5.png" alt="" /></a>
								</figure>
							</div><!-- Client 5 end -->

							<div class="col-sm-4">
								<figure class="clients-logo">
									<a href="#"><img class="img-responsive" src="<?php echo URL?>assets/images/clients/client6.png" alt="" /></a>
								</figure>
							</div><!-- Client 6 end -->
				...
				<div class="row">
						...
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?php echo URL?>assets/images/news/news1.jpg" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
					...
					<div class="col-md-4 col-xs-12">
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?php echo URL?>assets/images/news/news2.jpg" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
					...
					<div class="col-md-4 col-xs-12">
						<div class="latest-post">
							<div class="latest-post-media">
								<a href="news-single.html" class="latest-post-img">
									<img class="img-responsive" src="<?php echo URL?>assets/images/news/news3.jpg" alt="img">
								</a>
							</div>
							<div class="post-body">
								<h4 class="post-title">
